...
use KaizenCoders\MagicLink\Helper;
use KaizenCoders\MagicLink\Cache;
...
class Install {
	...
	private static $db_updates = [
		'1.0.0' => [
			'kaizencoders_magic_link_update_100_db_version',
		],
	];
	...
	public static function install() {
		...
		if ( self::is_new_install() ) {
			...
			Helper::maybe_define_constant( 'KAIZENCODERS_MAGIC_LINK_INSTALLING', true );
	...
	private static function maybe_update_db_version() {
		if ( self::needs_db_update() ) {
			if ( apply_filters( 'kaizencoders_magic_link_enable_auto_update_db', true ) ) {
				self::update();
			}
		}
	}
